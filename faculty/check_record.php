...
<div class="main-content">
    ...
    <div class="container">
        ...
        <a href="add_student.php" class="btn btn-primary float-start"><i class="fa-solid fa-angle-left"></i> Back</a>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
               <hr>
                <div class="row mt-5">
<?php
 $sql3="select adate from attendance group by adate";
 $result3=$con->query($sql3);
 $result3->execute();
 $result=$result3->fetchAll(PDO::FETCH_ASSOC);
 foreach($result as $row2)
 {
?>
                    <div class="col-md-12">
                        <h3 class="text-center">Mark Attendance <?=$row2['adate']?></h3>
